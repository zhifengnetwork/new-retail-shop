    ...
    methods:{
        _getGoodsData(){
            ...
            .then((res)=>{
                ...
                _that.isCollect= _that.goodsData.collection     //初始化收藏
        ...
        confirmSize(){
            var _that=this;
            var checkData =this._selecetSku().info
            if(checkData.sku_id=="" || checkData.inventory==0){ this.$toast("改规格已售完"); return}
            _that.$axios.post('cart/addCart',{
                'sku_id':checkData.sku_id,
